                    ...
                    <tbody>
                        @forelse ($attendances as $attendance)
                            <tr>
                                ...
                                <td>{{$attendance->day_hours}}</td>
                                <td>{{$attendance->log_date}}</td>
                                <td>
                                    <div class="flex space-x-5">
                                        <div>
                                            <a href="{{route('admin.attendance.edit', ['id' => $attendance->id])}}"><button
                                                    class="btn btn-success"><i class="ri-pencil-line"></i></button></a>
                                        </div>
                                        <div>
                                            <form action="{{route('admin.attendance.delete', ['id' => $attendance->id])}}" method="post">
                                                @csrf
